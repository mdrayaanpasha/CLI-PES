...
//  - Pluggable runner (runScans) for core/types Scanner modules
//  - Global dependency tree resolution and multi-version conflict detection
//  - Security audits, retainer mapping, and final conflict reporting
...
// ============================================================================
// 2. Interfaces & Types for Dependency & Conflict Analysis
// ============================================================================
...
// ============================================================================
// 3. Color & Terminal Formatting Utilities
// ============================================================================
...
// ============================================================================
// 4. Package Manager & File Utilities
// ============================================================================
...
// ============================================================================
// 6. Top-Level Dependency Breakdown
// ============================================================================
...
// ============================================================================
// 8. Global Dependency Graph Builder
// ============================================================================
...
// ============================================================================
// 9. IDENTIFY ALL VERSION CONFLICTS
// ============================================================================

/**
 * Scans all packages across the project and returns detected version conflicts.
 */
...
// ============================================================================
// 12. Standalone CLI Runner (if invoked directly)
// ============================================================================

export function runStandaloneScanner(): void {
...
// Run standalone if executed directly via node or tsx
if (
  process.argv[1] &&
  (process.argv[1].endsWith("core/scanner.ts") ||
    process.argv[1].endsWith("core\\scanner.ts") ||
    process.argv[1].endsWith("core/scanner.js") ||
    process.argv[1].endsWith("core\\scanner.js"))
) {
  runStandaloneScanner();
}
