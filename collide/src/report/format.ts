...
export function printReport(
  ...
  // ── Logo ──
  printLogo("v0.1.0  ·  npm dependency scanner");
  ...
  // Fix-it hint
  console.log(
    `${INDENT}${c.dim(c.gray(`${sym.arrow} Run `))}` +
      c.cyan("npm audit fix") +
      c.dim(c.gray(" or upgrade affected packages to resolve OSV findings.")),
  );
  console.log("");
}
